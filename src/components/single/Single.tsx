    ...
    <div className='single'>
      ...
      <div className="activities">
          ...
          <ul>
            <li>
              <div>
                <p>John Doe purchased Playstation % Special Edition</p>
